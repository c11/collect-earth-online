...
class TimeSync extends React.Component {
    ...
    <script>
        ...
        <span class="glyphicon glyphicon-minus"></span>
            ...
            <div class="dropdown" style="display:inline-block; margin-right:15px;">
            <button id="helpBtn" class="btn btn-default btn-xs dropdown-toggle" type="button" data-toggle="dropdown" style="font-size:11px; margin-bottom:2px; height:21.7167px; text-align: left;">
        Help
        </button>
        ...
        <div id="containerDiv">
            ...
            <ul id="plotList"> //will be filled in on-the-fly
            </ul>
            </div>

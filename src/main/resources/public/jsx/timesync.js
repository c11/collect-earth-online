    ...
    render() {
        ...
        <div id="topSection">
            ...
            <div class="dropdown" style="display:inline-block; margin-right:15px;">
                <button id="projBtn" class="btn btn-default btn-xs dropdown-toggle" type="button" data-toggle="dropdown"
            ...
            <div class="dropdown" style="display:inline-block; margin-right:15px;">
                <button id="packetBtn" class="btn btn-default btn-xs dropdown-toggle" type="button" data-toggle="dropdown"
                        style="font-size:11px; margin-bottom:2px; height:21.7167px; width:100px; text-align: left;">
                    <span class="caret projBtn"></span>
                </button>
                <ul id="packetList" class="dropdown-menu"></ul>
            </div>
            ...
            <div class="dropdown" style="display:inline-block; margin-right:15px;">
                <button id="helpBtn" class="btn btn-default btn-xs dropdown-toggle" type="button" data-toggle="dropdown"
                ...
                <ul id="helpList" class="dropdown-menu">
                    ...
                    <li id="toolTips">
                        Tool Tips<span id="toolTipsCheck" class="glyphicon glyphicon-none" style="margin-left:4px"></span>
                    </li>
                </ul>
            </div>
            <button id="exportBtn" class="btn btn-default btn-xs dropdown-toggle" type="button" data-toggle="dropdown"
                    style="font-size:11px; margin-bottom:2px; height:21.7167px; text-align: left;">
                Export Data
            </button>
        ...
        <div id="containerDiv">
                ...
                <div class="btn-group" role="group" aria-label="..." style="margin:-1px; display: inline-block;">
                    <div class="btn-group specPlotDrop" role="group">
                        <button id="btnIndex" class="btn btn-default dropdown-toggle specPlotBtn" type="button"
                            ...
                            <div>
                                <strong>Index/Band</strong>:<br /><small>TC Wetness</small><span class="caret specPlot"></span>
                            </div>
                        </button>
                    ...
                    <div class="btn-group specPlotDrop" role="group">
                        <button id="btnChipSet" class="btn btn-default dropdown-toggle specPlotBtn" type="button">
                            <div>
                                <strong>Chip Set</strong>:<br/><small>SWIR2,NIR,Red</small><span class="caret specPlot"></span>
                            </div>
                        </button>
                    ...
                    <div class="btn-group" role="group">
                        <button id="btnPoints" class="btn btn-default specPlotBtn" type="button">
                            <strong>Show All</strong><br /><span id="allPointsDisplayThumb" class="glyphicon glyphicon-thumbs-down"
                                                                 aria-hidden="true"></span>
                        </button>
                    </div>
                    <div class="btn-group" role="group">
            ...
            <div id="formsDiv" class="sectionDiv">
                <div class="header">
                    ...
                    <button id="saveBtn" class="btn btn-default btn-xs" type="button"
                            style="font-size:11px; margin-bottom:2px; height:21.7167px; text-align: left;">
                        Save
                    </button>
                </div>
                <ul class="test">
                    <li id="segmentsFormTab" class="selected" style="border-top-left-radius:4px; text-align:center;">
                        Segments
                    </li>
                    <li id="verticesFormTab" class="unselected" style="margin-left:-1px; text-align:center;">
                        Vertices
                    </li>
                    <li id="CommentsFormTab" class="unselected"
                ...
                <div id="changeProcessDiv" class="dropThis">
                    ...
                    <ul id="CPnotesList" class="notesList">
                        <li><input id="natural" class="natural forFire" type="checkbox" name="changeProcess" value="natural"
                                   autocomplete="off"/> Natural</li>
                        <li><input id="clearcut" class="clearcut forHarvest" type="checkbox" name="changeProcess" value="clearcut"
                                   autocomplete="off"/> Clearcut</li>
                        <li><input id="thinning" class="thinning forHarvest" type="checkbox" name="changeProcess" value="thinning"
                                   autocomplete="off"/> Thinning</li>
                        <li><input id="prescribed" class="prescribed forFire" type="checkbox" name="changeProcess" value="prescribed"
                                   autocomplete="off"/> Prescribed</li>
                        <li><input id="sitePrepFire" class="sitePrepFire forFire forHarvest" type="checkbox" name="changeProcess"
                                   value="sitePrepFire" autocomplete="off"/> Site-prep fire</li>
                        <li><input id="flooding" class="flooding forHydro" type="checkbox" name="changeProcess" value="flooding"
                                   autocomplete="off"/> Flooding</li>
                        <li><input id="reserviorLakeFlux" class="reserviorLakeFlux forHydro" type="checkbox" name="changeProcess"
                                   value="reserviorLakeFlux" autocomplete="off"/> Reservoir/Lake flux</li>
                        <li><input id="wetlandDrainage" class="wetlandDrainage forConserv" type="checkbox" name="changeProcess"
                                   value="wetlandDrainage" autocomplete="off"/> Wetland drainage</li>
                        <li><input id="airphotoOnly"
                                   class="airphotoOnly forFire forHarvest forDecline forAcuteDecline forConditionDecline forWind forHydro forDebris forGrowth forStable forMechanical forOther"
                            ...
                            <td style="padding:0px 0px 0px 0px; border:none;">
                                <div id="landUseDiv" style="margin:4px 2px 0px 4px;">
                                    ...
                                    <ul id="luLevelSwitchHolder" class="lulcLevelSwitchHolder">
                                        <li id="LUprimaryTab" class="selected" style="border-top-left-radius:4px; text-align:center;">Primary</li>
                                    ...
                                    <ul id="LUnotesList" class="notesList">
                                        <li><input id="wetland" class="wetland forForest" type="checkbox" name="landUse" value="wetland"
                                                   autocomplete="off"/> Wetland</li>
                                        <li><input id="mining" class="mining forDeveloped" type="checkbox" name="landUse" value="mining"
                                                   autocomplete="off"/> Mining</li>
                                        <li><input id="rowCrop" class="rowCrop forAg" class="rowCrop forAg" type="checkbox" name="landUse"
                                                   value="rowCrop" autocomplete="off"/> Row crop</li>
                                        <li><input id="orchardTreeFarm" class="orchardTreeFarm forAg" type="checkbox" name="landUse"
                            ...
                            <td style="padding:0px 0px 0px 0px; border:none;">
                                <div id="landCoverDiv" style="margin:4px 4px 0px 3px">
                                    ...
                                    <ul id="lcLevelSwitchHolder" class="lulcLevelSwitchHolder">
                                        <li id="LCprimaryTab" class="selected"
                                    ...
                                    <ul id="LCnotesList" class="notesList">
                                        <li class="trees"><input id="trees" type="checkbox" name="landCover" value="trees" autocomplete="off"/> Trees
                                        </li>
                                        <li class="shrubs"><input id="shrubs" type="checkbox" name="landCover" value="shrubs" autocomplete="off"/>
                                            Shrubs</li>
                                        <li class="grassForbHerb"><input id="grassForbHerb" type="checkbox" name="landCover" value="grassForbHerb"
                                                                         autocomplete="off"/> Grass/forb/herb</li>
                                        <li class="impervious"><input id="impervious" type="checkbox" name="landCover" value="impervious"
                                                                      autocomplete="off"/> Impervious</li>
                                        <li class="naturalBarren"><input id="naturalBarren" type="checkbox" name="landCover" value="naturalBarren"
                                                                         autocomplete="off"/> Barren</li>
                                        <li class="snowIce"><input id="snowIce" type="checkbox" name="landCover" value="snowIce" autocomplete="off"/>
                                            Snow/ice</li>
                                        <li class="water"><input id="water" type="checkbox" name="landCover" value="water" autocomplete="off"/> Water
                                        </li>
                                    </ul>
                                </div>
                            </td>
